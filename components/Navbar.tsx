  ...
  return (
    <nav id="nav" className="w-full border-b border-line">
      <div className="mx-auto px-4 md:flex md:items-center md:justify-between md:px-8 lg:max-w-7xl">
          ...
          >
            {navOpen ? (
              ...
              <>
                ...
                <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="printHidden h-6 w-6">
        ...
        <div className={`border-t border-line-subtle pb-4 md:border-none md:pb-0 ${navOpen ? 'block' : 'hidden'} md:block`}>
            ...
            {NAV_LINKS.map(({ href, label }) => (
              <li key={href}>
                <Link
                  href={href}
                  onClick={close}
                  className="block py-2 px-2 text-base font-medium md:inline md:p-0 md:text-sm"
                >
                  {label}
                </Link>
              </li>
